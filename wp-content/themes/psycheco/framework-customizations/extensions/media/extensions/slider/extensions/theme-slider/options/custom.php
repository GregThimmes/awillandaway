...
$options = array(
	'slide_image_size' => array(
		'type'         => 'switch',
		'label'        => esc_html__( 'Use Full image Size', 'psycheco' ),
		'value'       => '',
		'left-choice'  => array(
			'value' => 'psycheco-large-width',
	...
	'slide_vertical_align'     => array(
		...
		'choices'     => array(
			...
			'intro_text_top'    => esc_html__( 'Top', 'psycheco' ),
			'intro_text_bottom' => esc_html__( 'Bottom', 'psycheco' ),
		),
		/**
		 * Allow save not existing choices
		 * Useful when you use the select to populate it dynamically from js
