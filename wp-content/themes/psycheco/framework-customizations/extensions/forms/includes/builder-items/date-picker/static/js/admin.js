fwEvents.one('fw-builder:'+ 'form-builder' +':register-items', function(builder){
    var currentItemType = 'date-picker';
    var localized = window['fw_form_builder_item_type_date_picker'];

    var ItemView = builder.classes.ItemView.extend({
        template: _.template(
            '<div class="fw-form-builder-item-style-default fw-form-builder-item-type-text fw-form-builder-item-type-'+ currentItemType +'">'+
            ...
            '<label><input type="text" class="form-builder-select-time"/></label><br/>'+
            '</div>'+
            '</div>'+
            '</div>'
        ),
