...
class Psycheco_Theme_Includes {
	...
	public static function init() {
		...
		//theme path
		self::$template_directory = PSYCHECO_THEME_PATH;

		self::$template_directory_uri = PSYCHECO_THEME_URI;
		 ...
		 */
		{
			...
			if( defined('PSYCHECO_ENABLE_WIDGET_ADDS' ) ) {
	...
	public static function get_parent_path( $rel_path ) {
		return PSYCHECO_THEME_PATH . self::get_rel_path( $rel_path );
	}
